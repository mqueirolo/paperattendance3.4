...
if ($action == "edit") {
	if ($sesspageid == null) {
		...
		if ($session = $DB->get_record("paperattendance_sessionpages", array("id" => $sesspageid))){
			...
			$inputs = html_writer::div('<div class="form-group"><div class="col-sm-6"<label for="course">Shortname del Curso:</label><div class="input-group"><input type="text" class="form-control" id="course" placeholder="2113-V-ECO121-1-1-2017"><div class="input-group-btn"><button id="sn" type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#shortnamemodal">?</button></div></div></div>',"row");
			//Input for the Date of the list like: 01-08-2017
			$inputs .= html_writer::nonempty_tag('<div class="col-sm-6"><label for="date">Fecha:</label><div class="input-group"><input type="text" class="form-control" id="date" placeholder="01-08-2017"><div class="input-group-btn"><button id="d" type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#datemodal">?</button></div></div></div></div>',"form-group");
							    ...
							    <div class="modal-dialog modal-lg">
							      <div class="modal-content">
							        <div class="modal-body">
									  ...
									  <img class="img-responsive" src="img/hshortname.png" style="margin:auto;"> 
							        </div>
